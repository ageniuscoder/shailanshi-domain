...
import { galleryImages } from "../data/nancyyData.jsx"; // Imported galleryImages
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-12">
            <div className="flex justify-center items-center mb-6">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-pink-500 to-yellow-500 font-playfair animate-fadeIn">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {galleryImages.map((image, index) => (
              <div
                key={index}
                className="group relative overflow-hidden rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 border-4 border-transparent hover:border-pink-400"
              >
                <img
                  src={image.url}
                  alt={image.title}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-purple-900 via-pink-900 to-transparent opacity-0 group-hover:opacity-90 transition-opacity duration-500 flex flex-col items-center justify-center p-6">
                  <Heart
                    ...
                    size={48}
                  />
                  <h3 className="text-2xl font-bold text-white mb-3 font-playfair text-center">
                    {image.title}
                  </h3>
          ...
          <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-yellow-500 rounded-3xl shadow-2xl p-12 text-center">
            <h3 className="text-4xl md:text-5xl font-bold text-white mb-6 font-playfair">
              A Picture is Worth a Thousand Words
            </h3>
            <p className="text-xl md:text-2xl text-white leading-relaxed">
              But even a thousand words can't fully capture the essence of
              Nancyy. You just have to experience the greatness firsthand! 📸✨
            </p>
          </div>
        </div>
      </section>
